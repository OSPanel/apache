...
set "URL_ZLIB=https://files.ospanel.io/apache/zlib-1.3.1.tar.gz"
set "URL_PCRE2=https://files.ospanel.io/apache/pcre2-10.45.tar.gz"
set "URL_EXPAT=https://files.ospanel.io/apache/expat-2.7.1.tar.xz"
set "URL_OPENSSL=https://files.ospanel.io/apache/openssl-3.5.2.tar.gz"
set "URL_LIBXML2=https://files.ospanel.io/apache/libxml2-2.14.5.tar.xz"
set "URL_JANSSON=https://files.ospanel.io/apache/jansson-2.14.1.tar.gz"
set "URL_BROTLI=https://files.ospanel.io/apache/v1.1.0.tar.gz"
set "URL_LUA=https://files.ospanel.io/apache/lua-5.4.8.tar.gz"
set "URL_APR=https://files.ospanel.io/apache/apr-1.7.6.tar.gz"
set "URL_APR_UTIL=https://files.ospanel.io/apache/apr-util-1.6.3.tar.gz"
set "URL_NGHTTP2=https://files.ospanel.io/apache/nghttp2-1.66.0.tar.xz"
