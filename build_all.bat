...
set "URL_ZLIB=https://file.ospanel.io/apache/zlib-1.3.1.tar.gz"
set "URL_PCRE2=https://file.ospanel.io/apache/pcre2-10.45.tar.gz"
set "URL_EXPAT=https://file.ospanel.io/apache/expat-2.7.1.tar.xz"
set "URL_OPENSSL=https://file.ospanel.io/apache/openssl-3.5.2.tar.gz"
set "URL_LIBXML2=https://file.ospanel.io/apache/libxml2-2.14.5.tar.xz"
set "URL_JANSSON=https://file.ospanel.io/apache/jansson-2.14.1.tar.gz"
set "URL_BROTLI=https://file.ospanel.io/apache/v1.1.0.tar.gz"
set "URL_LUA=https://file.ospanel.io/apache/lua-5.4.8.tar.gz"
set "URL_APR=https://file.ospanel.io/apache/apr-1.7.6.tar.gz"
set "URL_APR_UTIL=https://file.ospanel.io/apache/apr-util-1.6.3.tar.gz"
set "URL_NGHTTP2=https://file.ospanel.io/apache/nghttp2-1.66.0.tar.xz"
set "URL_CURL=https://file.ospanel.io/apache/curl-8.15.0.tar.xz"
set "URL_HTTPD=https://file.ospanel.io/apache/httpd-2.4.65.tar.bz2"
set "URL_MOD_FCGID=https://file.ospanel.io/apache/mod_fcgid-2.3.9.tar.gz"
...
if exist "%BUILD_BASE%\!PACKAGE!" (
  ...
  cmake -G "NMake Makefiles" %~2 -DCMAKE_IGNORE_PATH="C:/Program Files/OpenSSL" -DCMAKE_EXE_LINKER_FLAGS="/DYNAMICBASE" -DCMAKE_SHARED_LINKER_FLAGS="/DYNAMICBASE" -DCMAKE_C_FLAGS="/DFD_SETSIZE=32768" -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -S "!SRC_DIR!" -B . & call :get_status
  if !STATUS! == 0 (
    nmake & call :get_status
    if !STATUS! == 0 (
      nmake install & call :get_status
