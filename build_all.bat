...
if !STATUS! == 0 (
  ...
  set APR_CMAKE_OPTS=-DCMAKE_INSTALL_PREFIX=%PREFIX% -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DMIN_WINDOWS_VER=0x0600 -DAPR_HAVE_IPV6=ON -DAPR_INSTALL_PRIVATE_H=ON -DAPR_BUILD_TESTAPR=OFF -DINSTALL_PDB=%INSTALL_PDB% -DCMAKE_C_FLAGS=/DFD_SETSIZE=32768 -DCMAKE_POLICY_VERSION_MINIMUM=3.5
...
if !STATUS! == 0 (
  ...
  set APR-UTIL_CMAKE_OPTS=-DCMAKE_INSTALL_PREFIX=%PREFIX% -DOPENSSL_ROOT_DIR=%PREFIX% -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DAPU_HAVE_CRYPTO=ON -DAPR_BUILD_TESTAPR=OFF -DINSTALL_PDB=%INSTALL_PDB% -DCMAKE_C_FLAGS=/DFD_SETSIZE=32768 -DCMAKE_POLICY_VERSION_MINIMUM=3.5
