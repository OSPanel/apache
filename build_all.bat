...
if !STATUS! == 0 (
  set "APR-UTIL_CMAKE_OPTS=-DCMAKE_INSTALL_PREFIX=%PREFIX% -DCMAKE_BUILD_TYPE=%BUILD_TYPE% -DOpenSSL_ROOT_DIR=%PREFIX% -DAPU_HAVE_CRYPTO=OFF -DAPU_HAVE_DSO=OFF -DAPRUTIL_WITH_ODBC=OFF -DAPRUTIL_WITH_LDAP=OFF -DAPR_BUILD_TESTAPR=OFF -DINSTALL_PDB=%INSTALL_PDB%"
