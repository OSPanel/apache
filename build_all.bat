...
if exist "%BUILD_BASE%\!PACKAGE!" (
  ...
  cmake -G "NMake Makefiles" %~2 -DCMAKE_EXE_LINKER_FLAGS="/BASE:0x140000000" -DCMAKE_SHARED_LINKER_FLAGS="/BASE:0x140000000" -DCMAKE_C_FLAGS="/DFD_SETSIZE=32768" -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -S "!SRC_DIR!" -B . & call :get_status
  if !STATUS! == 0 (
    nmake & call :get_status
    if !STATUS! == 0 (
      nmake install & call :get_status
